...
- [swarmlibs/node-metadata-agent](https://github.com/swarmlibs/node-metadata-agent) -  (today)
...
- [hashicorp/vault](https://github.com/hashicorp/vault) ([v1.17.2](https://github.com/hashicorp/vault/releases/tag/v1.17.2), 1 day ago) - A tool for secrets management, encryption as a service, and privileged access management
