...
- [docker/bake-action](https://github.com/docker/bake-action) ([v7.4.0](https://github.com/docker/bake-action/releases/tag/v7.4.0), 4 days ago) - GitHub Action to use Docker Buildx Bake as a high-level build command
