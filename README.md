...
- [socheatsok78/nix-containers](https://github.com/socheatsok78/nix-containers) - A collections of Nix container images using BuildKit-Nix (6 days ago)
...
- [docker/bake-action](https://github.com/docker/bake-action) ([v7.4.0](https://github.com/docker/bake-action/releases/tag/v7.4.0), 1 day ago) - GitHub Action to use Docker Buildx Bake as a high-level build command
