...
- [cacheserver/flutter](https://github.com/cacheserver/flutter) - This is a cache server for the Flutter SDK archive. It is designed to be deployed in a private network to cache Flutter SDK releases to reduce the load on the public servers and speed up the download process. (today)
- [cacheserver/huggingface](https://github.com/cacheserver/huggingface) - This is a cache server for the huggingface.co hub. It is designed to be deployed in a private network to cache models and datasets downloaded from the hub to reduce the load on the public servers and speed up the download process. (today)
- [cacheserver/linux-packages](https://github.com/cacheserver/linux-packages) - This is a cache server for Linux package repositories, it is designed to be deployed in a private network to cache Linux package to reduce the load on the public servers and speed up the download process. (today)
- [chocolatefrappe/huggingface-cacheserver](https://github.com/chocolatefrappe/huggingface-cacheserver) - This is a cache server for the huggingface.co hub. It is designed to be deployed in a private network to cache models and datasets downloaded from the hub to reduce the load on the public servers and speed up the download process. (1 day ago)
- [chocolatefrappe/linux-packages-cacheserver](https://github.com/chocolatefrappe/linux-packages-cacheserver) - This is a cache server for Linux package repositories, it is designed to be deployed in a private network to cache Linux package to reduce the load on the public servers and speed up the download process. (1 day ago)
...
- [fosrl/pangolin](https://github.com/fosrl/pangolin) ([1.6.2](https://github.com/fosrl/pangolin/releases/tag/1.6.2), 6 days ago) - Tunneled Reverse Proxy Server with Identity and Access Control and Dashboard UI
