...
- [swarmlibs/prometheus-configs-provider](https://github.com/swarmlibs/prometheus-configs-provider) - This is a simple tool that reads the Docker API and generates Prometheus scrape configs from Docker configs. (2 days ago)
...
- [swarmlibs/hashicorp-vault](https://github.com/swarmlibs/hashicorp-vault) - A tool for secrets management, encryption as a service, and privileged access management (5 days ago)
...
- [hashicorp/vault](https://github.com/hashicorp/vault) ([v1.17.1](https://github.com/hashicorp/vault/releases/tag/v1.17.1), 4 days ago) - A tool for secrets management, encryption as a service, and privileged access management
