...
- [socheatsok78/gickup-action](https://github.com/socheatsok78/gickup-action) ([2.0.5](https://github.com/socheatsok78/gickup-action/releases/tag/2.0.5), 2 days ago) - A GitHub Action for backing up any git repositories using gickup
- [docker/bake-action](https://github.com/docker/bake-action) ([v7.2.0](https://github.com/docker/bake-action/releases/tag/v7.2.0), 3 weeks ago) - GitHub Action to use Docker Buildx Bake as a high-level build command
