...
- [swarmlibs/portainer-templates](https://github.com/swarmlibs/portainer-templates) - App Templates used by Portainer (1 day ago)
- [swarmlibs/stacks](https://github.com/swarmlibs/stacks) - A collection of Docker Stack template files for various services. (1 day ago)
- [swarmlibs/traefik-ingress](https://github.com/swarmlibs/traefik-ingress) - An ingress service using Traefik Edge Router with LoadBalancer using HAProxy for Docker Swarm. (2 days ago)
...
- [hashicorp/vault](https://github.com/hashicorp/vault) ([v1.18.1](https://github.com/hashicorp/vault/releases/tag/v1.18.1), 1 day ago) - A tool for secrets management, encryption as a service, and privileged access management
