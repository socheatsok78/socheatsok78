...
- [fosrl/pangolin](https://github.com/fosrl/pangolin) ([1.17.1](https://github.com/fosrl/pangolin/releases/tag/1.17.1), today) - Identity-aware VPN and reverse proxy for remote access
- [docker/bake-action](https://github.com/docker/bake-action) ([v7.1.0](https://github.com/docker/bake-action/releases/tag/v7.1.0), 4 days ago) - GitHub Action to use Docker Buildx Bake as a high-level build command
