...
- [swarmlibs/portainer-template-server](https://github.com/swarmlibs/portainer-template-server) - A lightweight Portainer template server (2 days ago)
- [swarmlibs/portainer-templates](https://github.com/swarmlibs/portainer-templates) - This repository hosts the templates (Apps Templates) definitions for Portainer. (3 days ago)
- [swarmlibs/stacks](https://github.com/swarmlibs/stacks) - A collection of Docker Stack template files for various services. (4 days ago)
...
- [swarmlibs/traefik-ingress](https://github.com/swarmlibs/traefik-ingress) - An ingress service using Traefik Edge Router with LoadBalancer using HAProxy for Docker Swarm. (6 days ago)
...
- [hashicorp/vault](https://github.com/hashicorp/vault) ([v1.18.1](https://github.com/hashicorp/vault/releases/tag/v1.18.1), 5 days ago) - A tool for secrets management, encryption as a service, and privileged access management
