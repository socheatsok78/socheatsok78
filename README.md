...
- [socheatsok78/nix-containers](https://github.com/socheatsok78/nix-containers) - A collections of Nix container images using BuildKit-Nix (5 days ago)
- [socheatsok78/docker-flake-metadata](https://github.com/socheatsok78/docker-flake-metadata) - GitHub Action to extract metadata from Nix Flakes for Docker Buildx Bake (6 days ago)
...
- [docker/bake-action](https://github.com/docker/bake-action) ([v7.4.0](https://github.com/docker/bake-action/releases/tag/v7.4.0), today) - GitHub Action to use Docker Buildx Bake as a high-level build command
