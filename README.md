...
- [socheatsok78-lab/spring-buildx-bake](https://github.com/socheatsok78-lab/spring-buildx-bake) -  (1 day ago)
...
- [soramitsukhmer-lab/dockerswarm-monitoring-stack](https://github.com/soramitsukhmer-lab/dockerswarm-monitoring-stack) - A simple one-click deployment of a `promstack` and `logstack` for Docker Swarm cluster. (2 days ago)
...
- [hashicorp/vault](https://github.com/hashicorp/vault) ([v1.17.5](https://github.com/hashicorp/vault/releases/tag/v1.17.5), 5 days ago) - A tool for secrets management, encryption as a service, and privileged access management
