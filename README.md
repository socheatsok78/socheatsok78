...
- [flutter-actions/setup-flutter](https://github.com/flutter-actions/setup-flutter) ([v4.1](https://github.com/flutter-actions/setup-flutter/releases/tag/v4.1), 1 day ago) - This GitHub Action installs and setup of a Flutter SDK
- [socheatsok78/macos-sdks](https://github.com/socheatsok78/macos-sdks) ([rolling](https://github.com/socheatsok78/macos-sdks/releases/tag/rolling), 6 days ago) - macOS SDKs for using with osxcross
