...
- [YouMightNotNeedKubernetes/rabbitmq](https://github.com/YouMightNotNeedKubernetes/rabbitmq) - A high-availability RabbitMQ deployment using Consul for Docker Swarm (2 days ago)
