...
- [dockerbakery/github-metadata-action](https://github.com/dockerbakery/github-metadata-action) ([v4.1](https://github.com/dockerbakery/github-metadata-action/releases/tag/v4.1), today) - GitHub Metadata Action for Docker Buildx Bake.
- [joseluisq/macosx-sdks](https://github.com/joseluisq/macosx-sdks) ([26.0](https://github.com/joseluisq/macosx-sdks/releases/tag/26.0), 4 days ago) - Some Mac OS X SDKs for development purposes with osxcross.
- [fosrl/pangolin](https://github.com/fosrl/pangolin) ([1.11.1](https://github.com/fosrl/pangolin/releases/tag/1.11.1), 6 days ago) - Identity-Aware Tunneled Reverse Proxy Server with Dashboard UI
