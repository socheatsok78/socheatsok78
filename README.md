...
- [dockerbakery/gradle-metadata-action](https://github.com/dockerbakery/gradle-metadata-action) - Gradle Metadata Action for Docker Buildx Bake (6 days ago)
...
- [dockerbakery/gradle-metadata-action](https://github.com/dockerbakery/gradle-metadata-action) ([v3.0](https://github.com/dockerbakery/gradle-metadata-action/releases/tag/v3.0), 6 days ago) - Gradle Metadata Action for Docker Buildx Bake
