...
- [soramitsukhmer-lab/docker-swarm-monitoring-stack](https://github.com/soramitsukhmer-lab/docker-swarm-monitoring-stack) - A monitoring stack for Docker Swarm cluster by Soramitsu Khmer Lab (1 day ago)
...
- [swarmlibs/grafana-snapshot-gateway](https://github.com/swarmlibs/grafana-snapshot-gateway) - A snapshot gateway for self-hosted Grafana server (2 days ago)
...
- [hashicorp/vault](https://github.com/hashicorp/vault) ([v1.17.3](https://github.com/hashicorp/vault/releases/tag/v1.17.3), 2 days ago) - A tool for secrets management, encryption as a service, and privileged access management
