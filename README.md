...
- [chocolatefrappe/cgit](https://github.com/chocolatefrappe/cgit) - A hyperfast web frontend for git repositories written in C (today)
...
- [fosrl/pangolin](https://github.com/fosrl/pangolin) ([1.15.4](https://github.com/fosrl/pangolin/releases/tag/1.15.4), 5 days ago) - Identity-aware VPN and proxy for remote access to anything, anywhere.
